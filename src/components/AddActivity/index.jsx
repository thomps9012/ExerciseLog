        ...
        <form noValidate onSubmit={e => e.preventDefault()}>
            <FormControl className={classes.formControl}>
                <div style={{marginTop: '20px', marginBottom: '30px'}}>
                    ...
                    >
                        <MenuItem value={1}>Sport Climbing</MenuItem>
                        <MenuItem value={2}>Bouldering</MenuItem>
                        <MenuItem value={3}>Kettlebell Circuit</MenuItem>
                        <MenuItem value={4}>Core Circuit</MenuItem>
                        <MenuItem value={5}>Hangboard Routine</MenuItem>
                    </Select>
                </div>
                <TextField
                    style={{marginTop: '5px'}}
                ...
                <TextField
                    ...
                    required
                    fullWidth
                    label="Sets/Reps, Edge Size, Weight"
                    value={activity.sets}
                    name="sets"
                    onChange={handleChange}
                />
